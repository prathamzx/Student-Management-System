...
if(isset($_POST['submit'])) {
    ...
    $dob=$_POST['dob']; 
    $status=$_POST['status'];
    $sql="UPDATE $tbl SET StudentName=:studentname,RollId=:roolid,EnrollmentId=:enrollmentid,Gender=:gender,DOB=:dob,Status=:status WHERE StudentId=:stid ";
                     ...
                     <div class="container-fluid">
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        <li>
                                            <a href="dashboard.php"><i class="fa fa-home">
                                                </i> Home
                                            </a>
                                        </li>
...
$sql = "SELECT $tbl.StudentName,$tbl.RollId,$tbl.RegDate,$tbl.StudentId,$tbl.Status,$tbl.EnrollmentId,$tbl.Gender,$tbl.DOB,tblclasses.ClassName,tblclasses.Section from $tbl join tblclasses on tblclasses.id=$tbl.ClassId where $tbl.StudentId=:stid";
...
<div class="col-sm-10">
<input type="text" name="enrollmentid" class="form-control" value="<?php echo htmlentities($result->EnrollmentId)?>" required="required" autocomplete="off">
</div>
</div>
