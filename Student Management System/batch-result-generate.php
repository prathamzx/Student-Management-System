...
$sql = "select $tbl.StudentId, $tbl.StudentName, $tbl.FatherName, $tbl.EnrollmentId, $tbl.RollId, $tbl.StudentBatch, tblresult.SubjectId, tblresult.".$sem.", tblresult.".$p_sem.", tblresult.".$s_sem.", tblresult.".$p_s_sem.", tblresult.".$credit_sem.", tblresult.".$p_credit_sem." from $tbl inner join tblresult on $tbl.StudentId = tblresult.StudentId AND $tbl.classid = :classid AND $tbl.StudentBatch = :batchid AND $tbl.Status = 1";
//echo $sql;
